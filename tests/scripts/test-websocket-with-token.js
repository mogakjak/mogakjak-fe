...
// 제공된 액세스 토큰
const accessToken = 'eyJhbGciOiJIUzI1NiJ9..BH_PZ5a7OR5XecPhtzVaS1L-2q-KNTfvDpsDLC51Bco';
...
async function testWebSocket() {
    ...
    try {
        ...
        const chatRoomsResponse = await axios.get(`${API_BASE_URL}/chat/room/group/list`, {
...
function testWebSocketConnection(roomId) {
    ...
    stompClient.debug = function(str) {
        if (str.includes('CONNECT') || str.includes('CONNECTED') || 
            str.includes('SUBSCRIBE') || str.includes('SEND') ||
