    ...
    try {
        ...
        try {
            ...
            if (loginError.response?.status === 401) {
                console.log('❌ 로그인 실패: 이메일 또는 비밀번호가 올바르지 않습니다.');
        ...
        return new Promise((resolve, reject) => {
            stompClient.connect(
                ...
                (frame) => {
                    ...
                    // 채팅방 목록 조회
                    axios.get(`${API_BASE_URL}/chat/room/group/list`, {
                        ...
                        if (response.data.length > 0) {
                            ...
                            console.log(`📡 4단계: Topic 구독 시도 (roomId: ${testRoomId})...`);
                            ...
                            console.log('⚠️  채팅방이 없습니다. 채팅방을 먼저 생성해주세요.');
                            stompClient.disconnect(() => {
                                resolve('no-rooms');
                            });
                        }
